              ...
              {[
                {
                  icon: Clock,
                  title: 'Response time',
                  body: 'We aim to reply within 24 hours on business days.',
                },
                {
                  icon: Mail,
                  title: 'Email us directly',
                  body: 'Prefer email? Reach us at hello@neur.co',
                },
                {
                  icon: MessageSquare,
                  title: 'Feedback welcome',
                  body: 'Tell us what you love, what needs work, or what you wish existed.',
                },
